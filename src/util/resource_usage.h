...
/*
 * Note by Jun:
 *  clock_gettime() has different API across Mac and Linux.
 *  Should replace it with C++11 chrono, however, we need to check its consitency across
 * different platforms, such as Mac and Linux.
