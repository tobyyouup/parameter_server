...
class SGDConfig : public ::google::protobuf::Message {
 public:
  ...
  // repeated .PS.FilterConfig push_filter = 13;
  inline int push_filter_size() const;
  inline void clear_push_filter();
  static const int kPushFilterFieldNumber = 13;
  inline const ::PS::FilterConfig& push_filter(int index) const;
  inline ::PS::FilterConfig* mutable_push_filter(int index);
  inline ::PS::FilterConfig* add_push_filter();
  inline const ::google::protobuf::RepeatedPtrField< ::PS::FilterConfig >&
      push_filter() const;
  inline ::google::protobuf::RepeatedPtrField< ::PS::FilterConfig >*
      mutable_push_filter();

  // repeated .PS.FilterConfig pull_filter = 14;
  inline int pull_filter_size() const;
  inline void clear_pull_filter();
  static const int kPullFilterFieldNumber = 14;
  inline const ::PS::FilterConfig& pull_filter(int index) const;
  inline ::PS::FilterConfig* mutable_pull_filter(int index);
  inline ::PS::FilterConfig* add_pull_filter();
  inline const ::google::protobuf::RepeatedPtrField< ::PS::FilterConfig >&
      pull_filter() const;
  inline ::google::protobuf::RepeatedPtrField< ::PS::FilterConfig >*
      mutable_pull_filter();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::PS::FilterConfig > push_filter_;
  ::google::protobuf::RepeatedPtrField< ::PS::FilterConfig > pull_filter_;
...
// repeated .PS.FilterConfig push_filter = 13;
inline int SGDConfig::push_filter_size() const {
  return push_filter_.size();
}
inline void SGDConfig::clear_push_filter() {
  push_filter_.Clear();
}
inline const ::PS::FilterConfig& SGDConfig::push_filter(int index) const {
  return push_filter_.Get(index);
}
inline ::PS::FilterConfig* SGDConfig::mutable_push_filter(int index) {
  return push_filter_.Mutable(index);
}
inline ::PS::FilterConfig* SGDConfig::add_push_filter() {
  return push_filter_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::PS::FilterConfig >&
SGDConfig::push_filter() const {
  return push_filter_;
}
inline ::google::protobuf::RepeatedPtrField< ::PS::FilterConfig >*
SGDConfig::mutable_push_filter() {
  return &push_filter_;
}

// repeated .PS.FilterConfig pull_filter = 14;
inline int SGDConfig::pull_filter_size() const {
  return pull_filter_.size();
}
inline void SGDConfig::clear_pull_filter() {
  pull_filter_.Clear();
}
inline const ::PS::FilterConfig& SGDConfig::pull_filter(int index) const {
  return pull_filter_.Get(index);
}
inline ::PS::FilterConfig* SGDConfig::mutable_pull_filter(int index) {
  return pull_filter_.Mutable(index);
}
inline ::PS::FilterConfig* SGDConfig::add_pull_filter() {
  return pull_filter_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::PS::FilterConfig >&
SGDConfig::pull_filter() const {
  return pull_filter_;
}
inline ::google::protobuf::RepeatedPtrField< ::PS::FilterConfig >*
SGDConfig::mutable_pull_filter() {
  return &pull_filter_;
}
