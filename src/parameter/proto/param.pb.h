...
class ParamCall : public ::google::protobuf::Message {
 public:
  ...
  // optional .PS.AssignOpType op = 2;
  inline bool has_op() const;
  inline void clear_op();
  static const int kOpFieldNumber = 2;
  inline ::PS::AssignOpType op() const;
  inline void set_op(::PS::AssignOpType value);
...
// optional .PS.AssignOpType op = 2;
inline bool ParamCall::has_op() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ParamCall::set_has_op() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ParamCall::clear_has_op() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ParamCall::clear_op() {
  op_ = 0;
  clear_has_op();
}
inline ::PS::AssignOpType ParamCall::op() const {
  return static_cast< ::PS::AssignOpType >(op_);
}
inline void ParamCall::set_op(::PS::AssignOpType value) {
  assert(::PS::AssignOpType_IsValid(value));
  set_has_op();
  op_ = value;
}
...
inline const ::PS::TailKeyFilter& ParamCall::tail_filter() const {
  return tail_filter_ != NULL ? *tail_filter_ : *default_instance_->tail_filter_;
}
inline ::PS::TailKeyFilter* ParamCall::mutable_tail_filter() {
  set_has_tail_filter();
  if (tail_filter_ == NULL) tail_filter_ = new ::PS::TailKeyFilter;
  return tail_filter_;
}
inline ::PS::TailKeyFilter* ParamCall::release_tail_filter() {
  clear_has_tail_filter();
  ::PS::TailKeyFilter* temp = tail_filter_;
  tail_filter_ = NULL;
  return temp;
}
inline void ParamCall::set_allocated_tail_filter(::PS::TailKeyFilter* tail_filter) {
  delete tail_filter_;
...
// optional int32 freq_threshold = 2;
inline bool TailKeyFilter::has_freq_threshold() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void TailKeyFilter::set_has_freq_threshold() {
  _has_bits_[0] |= 0x00000002u;
}
inline void TailKeyFilter::clear_has_freq_threshold() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void TailKeyFilter::clear_freq_threshold() {
  freq_threshold_ = 0;
  clear_has_freq_threshold();
}
inline ::google::protobuf::int32 TailKeyFilter::freq_threshold() const {
  return freq_threshold_;
}
inline void TailKeyFilter::set_freq_threshold(::google::protobuf::int32 value) {
