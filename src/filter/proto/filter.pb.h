...
class FilterConfig : public ::google::protobuf::Message {
 public:
  ...
  static const Type NOISE = FilterConfig_Type_NOISE;
...
// optional int32 num_bytes = 5 [default = 3];
inline bool FilterConfig::has_num_bytes() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void FilterConfig::set_has_num_bytes() {
  _has_bits_[0] |= 0x00000004u;
}
inline void FilterConfig::clear_has_num_bytes() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void FilterConfig::clear_num_bytes() {
  num_bytes_ = 3;
  clear_has_num_bytes();
}
inline ::google::protobuf::int32 FilterConfig::num_bytes() const {
  return num_bytes_;
}
inline void FilterConfig::set_num_bytes(::google::protobuf::int32 value) {
  set_has_num_bytes();
  num_bytes_ = value;
}
...
// optional float mean = 6;
inline bool FilterConfig::has_mean() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void FilterConfig::set_has_mean() {
  _has_bits_[0] |= 0x00000010u;
}
inline void FilterConfig::clear_has_mean() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void FilterConfig::clear_mean() {
  mean_ = 0;
  clear_has_mean();
}
inline float FilterConfig::mean() const {
  return mean_;
}
inline void FilterConfig::set_mean(float value) {
  set_has_mean();
  mean_ = value;
}

// optional float std = 7;
inline bool FilterConfig::has_std() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void FilterConfig::set_has_std() {
  _has_bits_[0] |= 0x00000020u;
}
inline void FilterConfig::clear_has_std() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void FilterConfig::clear_std() {
  std_ = 0;
  clear_has_std();
}
inline float FilterConfig::std() const {
  return std_;
}
inline void FilterConfig::set_std(float value) {
  set_has_std();
  std_ = value;
}
